...
class HalfCheetahDirEnv(HalfCheetahEnv_):
    ...
    def __init__(self, task:dict={}, **kwargs):
        ...
        self._task = {'direction':self._goal_dir}
    ...
    def toggle_task(self, random=False):
        if random:
            self._goal_dir = 2 * np.random.binomial(1, p=0.5, size=(1,)) - 1
        else:
            self._goal_dir = -self._goal_dir
